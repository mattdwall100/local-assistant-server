...
class AssistantAPIClient:
    ...
    def health(self) -> dict[str, Any]:
        logger.info(f"api_request_started | endpoint=/health")
    ...
    def transcribe(self, audio_bytes: bytes, session_id: str | None) -> dict[str, Any]:
        ...
        with log_latency(logger, "api_request_completed", endpoint="/transcribe", session_id=session_id):
    ...
    def synthesize(self, text: str, session_id: str | None) -> Any:
        ...
        with log_latency(logger, "api_request_completed", endpoint="/synthesize", session_id=session_id):
