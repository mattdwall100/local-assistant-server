...
class FallbackHandler:
    ...
    def handle(
        ...
        try:
            ...
            return FallbackStream(self.bytes_to_stream(fallback_bytes), fallback_text, session_id)
        except Exception as e:
        ...
        try:
            return FallbackStream(self.bytes_to_stream(b""), fallback_text, session_id)
        except Exception as e:
